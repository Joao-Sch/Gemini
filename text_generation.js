...
async function textGenTextOnlyPrompt() {
  ...
  const prompt = "fale em portugues";
...
async function textGenTextOnlyPromptStreaming() {
  ...
  const prompt = "me diga como posso passar parametros para a api do Gemini e fazer com que a saida seja em json, e. umprojeto usnado next.js e reacr com typescript";
